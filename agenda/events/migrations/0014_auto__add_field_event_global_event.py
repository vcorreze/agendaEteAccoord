...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.global_event'
        db.add_column(u'events_event', 'global_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.global_event'
        db.delete_column(u'events_event', 'global_event')
    ...
    models = {
        ...
        u'events.city': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cities'", 'to': u"orm['events.Region']"})
        },
        u'events.event': {
            ...
            'global_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
