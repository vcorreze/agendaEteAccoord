...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.moderator'
        db.add_column(u'events_region', 'moderator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='moderated_regions', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.moderator'
        db.delete_column(u'events_region', 'moderator_id')
