...
class SplitSelectDateTimeWidget(MultiWidget):
    ...
    http://www.djangosnippets.org/snippets/1202/) and SelectDateWidget (from
    django.forms.extras) so we have something like SpliteDateTimeWidget (in
